...
class ShelleyWalletFactory extends BlockchainAdapterFactory implements WalletFactory {
  ...
  static Future<WalletImpl> createWallet2({
    required HdWallet hdWallet,
    String? walletName,
    bool load = true,
    ...
    return WalletImpl(
      blockchainAdapter: BlockchainAdapterFactory.adapter2(),
      stakeAddress: stakeAddress,
  ...
  static Future<WalletImpl> createWalletFromMnemonic2({
    ...
    return createWallet2(hdWallet: hdWallet, walletName: walletName, load: load);
  }
