...
import 'package:flutter_wallet/embed/embed_global_back.dart';
import 'package:flutter_wallet/vendor/in_app_navigator_observer.dart';
import 'package:flutter_wallet/vendor/screen_adapt.dart';
import 'package:get/get.dart';
import 'package:loggy/loggy.dart';

/// 运行应用
/// fork [package:flutter_base_kit/base/application.dart]
///
/// [appName] 应用名称
/// [home] 应用主页-一般由启动页接管
  ...
  runZonedGuarded(() async {
    ...
    Loggy.initLoggy(
        ...
        logOptions: const LogOptions(
            kReleaseMode ? LogLevel.error : LogLevel.all,
    ...
    runApp(GetMaterialApp(
      ...
      navigatorObservers: navigatorObservers == null
          ? <NavigatorObserver>[
              SentryManager.navigatorObserver,
              BotToastNavigatorObserver(),
              InAppNavigatorObserver()
            ]
          : (<NavigatorObserver>[
              SentryManager.navigatorObserver,
              BotToastNavigatorObserver(),
      ...
      builder: (context, child) {
        return EmbedGlobalBack(builder: () {
          return ScreenAdapt(
