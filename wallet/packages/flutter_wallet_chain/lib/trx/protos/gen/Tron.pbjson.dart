...
const MarketOrderDetail$json = const {
  ...
  '2': const [
    ...
    const {'1': 'fillSellQuantity', '3': 3, '4': 1, '5': 3, '10': 'fillSellQuantity'},
    const {'1': 'fillBuyQuantity', '3': 4, '4': 1, '5': 3, '10': 'fillBuyQuantity'},
  ],
};
...
const TransactionInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'orderDetails', '3': 26, '4': 3, '5': 11, '6': '.protocol.MarketOrderDetail', '10': 'orderDetails'},
  ],
...
const MarketOrderPairList$json = const {
  ...
  '2': const [
    const {'1': 'orderPair', '3': 1, '4': 3, '5': 11, '6': '.protocol.MarketOrderPair', '10': 'orderPair'},
  ],
};
