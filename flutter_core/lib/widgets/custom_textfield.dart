...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  bool _isChecking = false;//输入检测
  bool _isConform = false;//输入一致性反馈
  /// 倒计时秒数
  ...
  void isEmpty() {
    ...
    if (isEmpty != _isShowDelete) {
      setState(() {
        ...
        _isChecking = widget.needCheckInput && (_isChecking || widget.controller.text.length > 0) && (_isFocus || !_isConform);
      });
    } else {
      setState(() {
        _isChecking = widget.needCheckInput && (_isChecking || widget.controller.text.length > 0) && (_isFocus || !_isConform);
  ...
  Widget build(BuildContext context) {
    ...
    final TextField textField = TextField(
      ...
      style: TextStyle(fontSize: Dimens.font_sp15, fontWeight: FontWeight.bold, color: Colours.primary_text),
      ...
      decoration: InputDecoration(
        ...
        prefixIconConstraints: const BoxConstraints(minWidth: 22, maxWidth: 52, minHeight: 25),
        contentPadding: const EdgeInsets.symmetric(vertical: 5),
        hintText: widget.hintText,
        hintStyle:
            TextStyle(fontSize: Dimens.font_sp15, fontWeight: FontWeight.normal, color: Colours.tertiary_text),
        counterText: '',
        ...
        child: Row(
          children: [
            ...
            TextButton(
              ...
              child: Text(
                _clickable ? I18nKeys.getting_captcha : '$_currentSecond s', //todo，缺少国际化 x秒后重新发送
    ...
    return Column(
      ...
      children: <Widget>[
        Container(
          child: Text(widget.labelText, style: TextStyle(color: Colours.tertiary_text, fontSize: 12)), //todo 动画
        ),
        Stack(
        ...
        Visibility(
          ...
          child: Text(widget.errorText, style: TextStyle(color: Colours.text_red, fontSize: 12)), //,
        ),
        //输入检测提示
        Visibility(
          visible: _isChecking,
