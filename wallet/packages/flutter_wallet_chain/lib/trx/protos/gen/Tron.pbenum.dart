...
class AccountType extends $pb.ProtobufEnum {
  static const AccountType Normal = AccountType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'Normal');
  static const AccountType AssetIssue = AccountType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AssetIssue');
  static const AccountType Contract = AccountType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'Contract');
...
class ReasonCode extends $pb.ProtobufEnum {
  static const ReasonCode REQUESTED = ReasonCode._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'REQUESTED');
  static const ReasonCode BAD_PROTOCOL = ReasonCode._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BAD_PROTOCOL');
  static const ReasonCode TOO_MANY_PEERS = ReasonCode._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TOO_MANY_PEERS');
  static const ReasonCode DUPLICATE_PEER = ReasonCode._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DUPLICATE_PEER');
  static const ReasonCode INCOMPATIBLE_PROTOCOL = ReasonCode._(6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INCOMPATIBLE_PROTOCOL');
  static const ReasonCode NULL_IDENTITY = ReasonCode._(7, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NULL_IDENTITY');
  static const ReasonCode PEER_QUITING = ReasonCode._(8, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PEER_QUITING');
  static const ReasonCode UNEXPECTED_IDENTITY = ReasonCode._(9, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNEXPECTED_IDENTITY');
  static const ReasonCode LOCAL_IDENTITY = ReasonCode._(10, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'LOCAL_IDENTITY');
  static const ReasonCode PING_TIMEOUT = ReasonCode._(11, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PING_TIMEOUT');
  static const ReasonCode USER_REASON = ReasonCode._(16, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'USER_REASON');
  static const ReasonCode RESET = ReasonCode._(17, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'RESET');
  static const ReasonCode SYNC_FAIL = ReasonCode._(18, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SYNC_FAIL');
  static const ReasonCode FETCH_FAIL = ReasonCode._(19, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FETCH_FAIL');
  static const ReasonCode BAD_TX = ReasonCode._(20, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BAD_TX');
  static const ReasonCode BAD_BLOCK = ReasonCode._(21, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BAD_BLOCK');
  static const ReasonCode FORKED = ReasonCode._(22, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FORKED');
  static const ReasonCode UNLINKABLE = ReasonCode._(23, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNLINKABLE');
  static const ReasonCode INCOMPATIBLE_VERSION = ReasonCode._(24, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INCOMPATIBLE_VERSION');
  static const ReasonCode INCOMPATIBLE_CHAIN = ReasonCode._(25, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INCOMPATIBLE_CHAIN');
  static const ReasonCode TIME_OUT = ReasonCode._(32, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TIME_OUT');
  static const ReasonCode CONNECT_FAIL = ReasonCode._(33, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CONNECT_FAIL');
  static const ReasonCode TOO_MANY_PEERS_WITH_SAME_IP = ReasonCode._(34, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TOO_MANY_PEERS_WITH_SAME_IP');
  static const ReasonCode UNKNOWN = ReasonCode._(255, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
...
class Proposal_State extends $pb.ProtobufEnum {
  static const Proposal_State PENDING = Proposal_State._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PENDING');
  static const Proposal_State DISAPPROVED = Proposal_State._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DISAPPROVED');
  static const Proposal_State APPROVED = Proposal_State._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'APPROVED');
  static const Proposal_State CANCELED = Proposal_State._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CANCELED');
...
class Permission_PermissionType extends $pb.ProtobufEnum {
  static const Permission_PermissionType Owner = Permission_PermissionType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'Owner');
  static const Permission_PermissionType Witness = Permission_PermissionType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'Witness');
  static const Permission_PermissionType Active = Permission_PermissionType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'Active');
...
class Transaction_Result_contractResult extends $pb.ProtobufEnum {
  static const Transaction_Result_contractResult DEFAULT = Transaction_Result_contractResult._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DEFAULT');
  static const Transaction_Result_contractResult SUCCESS = Transaction_Result_contractResult._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SUCCESS');
  static const Transaction_Result_contractResult REVERT = Transaction_Result_contractResult._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'REVERT');
  static const Transaction_Result_contractResult BAD_JUMP_DESTINATION = Transaction_Result_contractResult._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BAD_JUMP_DESTINATION');
  static const Transaction_Result_contractResult OUT_OF_MEMORY = Transaction_Result_contractResult._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'OUT_OF_MEMORY');
  static const Transaction_Result_contractResult PRECOMPILED_CONTRACT = Transaction_Result_contractResult._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PRECOMPILED_CONTRACT');
  static const Transaction_Result_contractResult STACK_TOO_SMALL = Transaction_Result_contractResult._(6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STACK_TOO_SMALL');
  static const Transaction_Result_contractResult STACK_TOO_LARGE = Transaction_Result_contractResult._(7, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STACK_TOO_LARGE');
  static const Transaction_Result_contractResult ILLEGAL_OPERATION = Transaction_Result_contractResult._(8, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ILLEGAL_OPERATION');
  static const Transaction_Result_contractResult STACK_OVERFLOW = Transaction_Result_contractResult._(9, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STACK_OVERFLOW');
  static const Transaction_Result_contractResult OUT_OF_ENERGY = Transaction_Result_contractResult._(10, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'OUT_OF_ENERGY');
  static const Transaction_Result_contractResult OUT_OF_TIME = Transaction_Result_contractResult._(11, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'OUT_OF_TIME');
  static const Transaction_Result_contractResult JVM_STACK_OVER_FLOW = Transaction_Result_contractResult._(12, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'JVM_STACK_OVER_FLOW');
  static const Transaction_Result_contractResult UNKNOWN = Transaction_Result_contractResult._(13, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
  static const Transaction_Result_contractResult TRANSFER_FAILED = Transaction_Result_contractResult._(14, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TRANSFER_FAILED');
...
class TransactionInfo_code extends $pb.ProtobufEnum {
  static const TransactionInfo_code SUCESS = TransactionInfo_code._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SUCESS');
  static const TransactionInfo_code FAILED = TransactionInfo_code._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FAILED');
...
class BlockInventory_Type extends $pb.ProtobufEnum {
  static const BlockInventory_Type SYNC = BlockInventory_Type._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SYNC');
  static const BlockInventory_Type ADVTISE = BlockInventory_Type._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ADVTISE');
  static const BlockInventory_Type FETCH = BlockInventory_Type._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FETCH');
...
class Inventory_InventoryType extends $pb.ProtobufEnum {
  static const Inventory_InventoryType TRX = Inventory_InventoryType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TRX');
  static const Inventory_InventoryType BLOCK = Inventory_InventoryType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BLOCK');
...
class Items_ItemType extends $pb.ProtobufEnum {
  static const Items_ItemType ERR = Items_ItemType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ERR');
  static const Items_ItemType TRX = Items_ItemType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TRX');
  static const Items_ItemType BLOCK = Items_ItemType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BLOCK');
  static const Items_ItemType BLOCKHEADER = Items_ItemType._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BLOCKHEADER');
...
class MarketOrder_State extends $pb.ProtobufEnum {
  static const MarketOrder_State ACTIVE = MarketOrder_State._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ACTIVE');
  static const MarketOrder_State INACTIVE = MarketOrder_State._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INACTIVE');
  static const MarketOrder_State CANCELED = MarketOrder_State._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CANCELED');
