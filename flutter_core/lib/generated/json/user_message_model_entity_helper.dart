...
userMessageModelEntityFromJson(UserMessageModelEntity data, Map<String, dynamic> json) {
...
Map<String, dynamic> userMessageModelEntityToJson(UserMessageModelEntity entity) {
